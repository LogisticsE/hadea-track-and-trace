...
CONFIG = {
    'client_id': 'bf4e6c9c-2fe5-4eb2-9e05-2785f8c2c42a',
    'client_secret': os.environ.get('PBI_CLIENT_SECRET', ''),  # Set via environment variable
    'tenant_id': 'c94e2732-29d6-41d6-89d9-08c9798a6601',
    'workspace_id': '7e8075a9-3b1f-430a-827e-b7f65d591c69',
    'report_id': '6d7bf2e6-e8b1-4d92-814d-1120d38053fb'
}
...
<head>
    ...
    <style>
        *, *::before, *::after {{ box-sizing: border-box; margin: 0; padding: 0; }}
        ...
        .support-btn:hover {{ color: #0078d4; border-bottom-color: #0078d4; }}
        /* Page footer */
        .page-footer {{
            position: absolute;
            bottom: 24px;
        ...
        <form method="POST" style="width:100%;">
            ...
            <div class="field">
                <div class="pw-label-row">
                    ...
                    <button type="button" class="forgot-btn">Forgot?</button>
                </div>
                <div class="input-wrap">
                    <svg class="input-icon" xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 256 256">
...
<body>
    ...
    <script>
        async function embedReport() {
            try {
                console.log('Fetching embed info from backend...');
                ...
                if (typeof powerbi === 'undefined') {
                    throw new Error('Power BI library not loaded');
                }
                ...
                document.getElementById('reportContainer').innerHTML = 
                    `<div class="error">Failed to load report: ${error.message}<br><br>Check browser console for details.</div>`;
            }
        }

        // Load report immediately when page loads
...
def get_embed_info():
    try:
        ...
        embed_url = f"https://api.powerbi.com/v1.0/myorg/groups/{CONFIG['workspace_id']}/reports/{CONFIG['report_id']}/GenerateToken"
        ...
        if response.status_code != 200:
            ...
            print(f"Error generating embed token: {error_msg}")
            return jsonify({'error': f'Failed to generate embed token: {error_msg}'}), response.status_code
        ...
        return jsonify({
            ...
            'embedUrl': embed_data.get('embedUrl', f"https://app.powerbi.com/reportEmbed?reportId={CONFIG['report_id']}&groupId={CONFIG['workspace_id']}"),
...
if __name__ == '__main__':
    print("Starting Power BI Embed server...")
